    ...
    <section id="about" className={css.section}>
      <div className={css.container}>
        ...
        <p className={css.text}>
          ...
          транспорту. Програмно-апаратний комплекс С.К.А.Т. призначений для автоматизації керування,
          контролю та обліку переміщень транспортних засобів, організації голосового зв&apos;язку
          між диспетчером та водіями, а також забезпечення безпеки транспортних засобів та водіїв.
        </p>
        <p className={css.text}>
