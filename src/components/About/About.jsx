    ...
    <div id="about" className={css.sectionAbout}>
      <div className={css.container}>
        ...
        <p className={css.text}>
          <span className={css.textSpan}>С.К.А.Т.</span> - це системи контролю автомобільного транспорту. Програмно-апаратний
          комплекс С.К.А.Т. призначений для автоматизації керування, контролю та обліку переміщень
          транспортних засобів, організації голосового зв'язку між диспетчером та водіями, а також
          забезпечення безпеки транспортних засобів та водіїв.
        </p>
        <p className={css.text}>
